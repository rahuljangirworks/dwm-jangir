...
[[ $DISTRO_ID == fedora ]] || fail "dwm-jangir supports Fedora only."

# ── Detect package manager and install ───────────────────
header "Installing xscreensaver"

install_pkg() {
	command -v dnf >/dev/null 2>&1 || fail "dnf is required; dwm-jangir supports Fedora only."
...
# XScreenSaver configuration — generated by dwm-jangir xscreensaver-setup.sh
